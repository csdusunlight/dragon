...
#    url(r'^(?P<board>\S+)/$', 'wafuli.views.board', name='board'),
    ...
    url(r'^welfare/(?:(?P<type>hb|yhq|by)/)?(?:list-page(?P<page>[0-9]*)/)?$', 'wafuli.welfare.welfare', name='welfare-list'),
    ...
    url(r'^information/(?:(?P<type>hb|yhq|by)/)?(?:list-page(?P<page>[0-9]*)/)?$', 'wafuli.views.information', name='information_list'),
]
