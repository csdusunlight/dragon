...
class DayStatis(models.Model):
    ...
    with_amount = models.DecimalField(u'提现成功金额', decimal_places = 2, max_digits=10, default=0.00)
    with_num = models.PositiveIntegerField(u"提现成功人数", default=0)
    ret_amount = models.DecimalField(u'返现金额', decimal_places = 2, max_digits=10, default=0.00)
...
class RecommendRank(models.Model):
    ...
    award = models.DecimalField(u'奖励金额', decimal_places = 2, max_digits=10, default=0.00)
    def __unicode__(self):
