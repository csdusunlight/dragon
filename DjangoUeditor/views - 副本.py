...
#         content111=UEditorField(u"新闻内容", width=900, height=600, toolbars="full", 
...
#         widget = UEditorWidget(attrs=content111.ueditor_settings)
#         ss = widget.render('nidaye', 'ccccaaaa')
#         return render(request,'test2.html',{'widget':ss})
#     if request.method == 'POST':
#         content = request.POST.get('nidaye')
#         print content
